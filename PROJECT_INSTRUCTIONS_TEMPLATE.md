...
This project uses `world-model-mcp` with project slug "{{PROJECT_SLUG}}" to maintain a persistent 3D/2D spatial internal world model, entity tracking, object permanence, and movement simulation.
